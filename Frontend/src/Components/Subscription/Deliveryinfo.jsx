  ...
  return (
    <div>
      ...
      <p className={style.addinfopara}>
        ...
        Post approval, your profile will be marked as ‘Featured’ in MeriJob Recruiter Database and we will refresh your profile automatically every week to give your profile a boost.
      </p>

      <p>
        <b>Jobs on Mail and SMS:</b>  After you make the payment, you will receive a mail from us within 24 hours to send us your latest resume. A i Expert will give you a call and discuss your job <br />
