  ...
  return (
    <Box className={styles.naukripulse} w={{base:"100%", sm:"100%"}} h="330px" bg={'#fff'} boxShadow='rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px' p={'4'}>
        <Flex gap={'2'}>
           ...
           <Text  fontSize='10px' fontWeight={'medium'}> MERIJOB PULSE</Text>
           </Box>
        ...
        <Flex w='100%' h='160px' mt='4' justifyContent={'space-between'}>
            <Box display={'flex'} flexDirection={"column"} justifyContent={"space-between"} alignItems={"center"} p={'3'} w={'24%'} h='100%' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                ...
                <Flex justifyContent={'space-between'} width={'100%'}>
                    <Text fontSize={'10px'} fontWeight='bold'>4.2 <Icon fontSize={'10px'} color={'yellow.400'} as={StarIcon}/></Text> 
                    <Text fontSize={'10px'}>11217 reviews</Text>
                </Flex>
            ...
            <Box display={'flex'} flexDirection={"column"} justifyContent={"space-between"} alignItems={"center"} p={'3'} w={'24%'} h='100%' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                ...
                <Flex justifyContent={'space-between'} width={'100%'}>
                    <Text fontSize={'10px'} fontWeight='bold'>4.1 <Icon fontSize={'10px'} color={'yellow.400'} as={StarIcon}/></Text> 
                    <Text fontSize={'10px'}>775 reviews</Text>
                </Flex>
            ...
            <Box display={'flex'} flexDirection={"column"} justifyContent={"space-between"} alignItems={"center"} p={'2'} w={'24%'} h='100%' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                <Text  fontSize='14px' fontWeight='medium'>Want to work for top companies?</Text>
                <Text mt={'2'} fontWeight='semibold' color={'gray.500'} fontSize={'10px'}>Stay active on MeriJob and recruiters will connect with you directly</Text>
                <Button w={'100%'} h='7' mt={'4'} bg='twitter.600' color={'#fff'} borderRadius='none'	onClick={() => navigate("/employement")}>Update Profile</Button>
            </Box>
            <Box display={'flex'} flexDirection={"column"} justifyContent={"space-between"} alignItems={"center"}  p='3' w={'24%'} h='100%' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                ...
                <Flex justifyContent={'space-between'} width={'100%'}>
                    <Text fontSize={'10px'} fontWeight='bold'>4.4 <Icon fontSize={'10px'} color={'yellow.400'} as={StarIcon}/></Text>
                    <Text fontSize={'10px'}>1495 reviews</Text>
                </Flex>
